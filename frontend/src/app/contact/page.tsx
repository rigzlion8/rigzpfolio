...
export const metadata: Metadata = {
  title: "Contact - Reagan Otieno | Software Developer",
  description: "Get in touch with Reagan Otieno, a passionate software developer specializing in Next.js, React, and full-stack web applications. Connect via LinkedIn, GitHub, or email.",
  keywords: [
    "contact",
    "software developer",
    "Reagan Otieno",
  ...
  openGraph: {
    title: "Contact - Reagan Otieno | Software Developer",
    description: "Get in touch with Reagan Otieno, a passionate software developer specializing in Next.js, React, and full-stack web applications.",
    type: "website",
  },
};
...
const socialLinks = [
  {
    name: "LinkedIn",
    url: "https://www.linkedin.com/in/reagan-musa",
    icon: (
  ...
  {
    name: "GitHub",
    url: "https://github.com/rigzlion8",
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "Email",
    url: "mailto:houseoftechke@gmail.com",
    icon: (
      ...
      <main className="px-4 sm:px-6 py-12 max-w-4xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-neutral-600 dark:text-neutral-300 mb-8 max-w-2xl mx-auto">
            I&apos;m Reagan Otieno, a passionate software developer specializing in modern web technologies. 
